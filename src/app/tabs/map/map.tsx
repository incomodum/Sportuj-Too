    ...
    return (
        <div className="relative min-h-full w-full flex-grow">
            <MapContainer
                    ...
                    <motion.div
                        ...
                        <div className="flex min-h-20 w-full flex-col gap-4 rounded-[34px] bg-white p-5">
                            <div className="flex flex-row gap-4">
                                <img
                                    className="bg-slate-400- flex h-auto w-1/2 flex-grow rounded-[21px] object-cover"
                                    src={popupInfo.image}
                                />
                            ...
                            <Link href={`/tabs/map/${popupInfo.id}`}>
                ...
                <div className="absolute top-4 flex w-full flex-col items-end gap-2 px-2 md:flex-row md:px-6">
